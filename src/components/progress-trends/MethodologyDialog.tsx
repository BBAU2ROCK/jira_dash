            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-2xl max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 text-sm text-foreground/90 mt-2">
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">1. 예측 모델 — Monte Carlo Throughput</h3>
                            <p>
                        ...
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">2. 3 시나리오 ETA</h3>
                        ...
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">3. 공수 추정 — Hybrid</h3>
                        ...
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">4. 신뢰도 등급</h3>
                            <p>활동일·CV·Scope ratio에 따라 4단계로 분류. 신뢰도가 낮으면 단일 날짜를 표시하지 않습니다 (정직성 원칙).</p>
                        </section>
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">5. 한계와 가정</h3>
                            <ul className="list-disc pl-5 space-y-0.5">
                        ...
                        <section>
                            <h3 className="font-semibold text-foreground mb-1">6. 정직성 원칙</h3>
                            <p>
