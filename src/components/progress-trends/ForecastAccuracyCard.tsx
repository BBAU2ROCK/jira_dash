            ...
            {acc.status === 'insufficient' ? (
                ...
                <>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-2">
                        <div>
                            <div className="text-[11px] text-muted-foreground">표본</div>
                            <div className="text-lg font-bold text-foreground tabular-nums">{acc.sampleSize}회</div>
                        </div>
                        <div>
                            <div className="text-[11px] text-muted-foreground">MAE <InfoTip>Mean Absolute Error — 예측 P85일수와 실제 소요일의 평균 절대 차이. 작을수록 정확.</InfoTip></div>
                            <div className="text-lg font-bold text-foreground tabular-nums">±{acc.maeP85Days}일</div>
                        </div>
                        <div>
                            <div className="text-[11px] text-muted-foreground">P85 적중률 <InfoTip>과거 예측 중 실제 완료일이 P85 이내에 들어온 비율. 85%면 잘 보정됨. 75% 미만이면 과신.</InfoTip></div>
                            <div className={cn(
                        ...
                        <div>
                            <div className="text-[11px] text-muted-foreground">P95 적중률</div>
